        ...
        new EmbedBuilder()
          ...
          .addFields([
            ...
            },
            {
              name: `Total Channels`,
              value: `${
                interaction.guild.channels.cache.size ?? "Not Cached or 0"
              }`,
              inline: true,
            },
            {
            ...
            {
              name: `Member Count`,
              value: `${interaction.guild.memberCount ?? "Not Cached or 0"}`,
              inline: true,
            },
            {
              name: `Owner`,
              value: `${
                interaction.client.users.cache.get(interaction.guild.ownerId)
                  .tag ?? "Couldn't cache Server Owner's Username & Tag"
              }`,
              inline: true,
            },
            {
              name: `Roles (${interaction.guild.roles.cache.size ?? "0"})`,
